...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      'Hands-on robotics, coding and AI for kids aged 6–16. Six tracks, competition-trained coaches. In-person and online. Book a free trial today.',
...
export default async function HomePage({
  ...
  const [homeContent, programmes, siteContent] = await Promise.all([
    getContent<typeof import('@/lib/content/ca/home.json')>(locale, 'home'),
    getContent<typeof import('@/lib/content/ca/programmes.json')>(locale, 'programmes'),
  ...
  const siteUrl = `https://nexusrobotics.com.au/${locale}`;
